...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, default=DEFAULT_CHECKPOINT_PATH, help="Path to the model checkpoint.")
    parser.add_argument("--cpu", action='store_true', default=DEFAULT_CPU, help="Run on CPU")
